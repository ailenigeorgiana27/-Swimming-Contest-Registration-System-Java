...
public class LoginControllerU  {
    ...
    private MainWindowControllerU mainCtrl;
    ...
    private void login(ActionEvent event) {
        ...
        try {
            service.login(user, pass, mainCtrl);
            crtUsername = user;
    ...
    public void setMainController(MainWindowControllerU mainCtrl) {
